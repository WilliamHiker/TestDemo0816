...
//            Logg.i("getActiveNetworkInfo: " + in);
            NetworkInfo[] info = connectivity.getAllNetworkInfo();
            if (info != null) {
                for (int i = 0; i < info.length; i++) {
                    // if (info[i].getType() == ConnectivityManager.TYPE_WIFI) {
//                    Logg.i("NetworkInfo[" + i + "]isAvailable : " + info[i].isAvailable());
//                    Logg.i("NetworkInfo[" + i + "]isConnected : " + info[i].isConnected());
//                    Logg.i("NetworkInfo[" + i + "]isConnectedOrConnecting : " + info[i].isConnectedOrConnecting());
//                    Logg.i("NetworkInfo[" + i + "]: " + info[i]);
                    // }
                }
//                Logg.i("\n");
            } else {
//                Logg.i("getAllNetworkInfo is null");
            }
        }
        return false;
    }
    ...
    public static int getConnectedTypeINT(Context context) {
        NetworkInfo net = getConnectivityManager(context).getActiveNetworkInfo();
        if (net != null) {
//            Logg.i("NetworkInfo: " + net.toString());
            return net.getType();
        }
        return -1;
    }
